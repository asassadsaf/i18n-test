...
public enum ErrorCodeEnum {
    ...
    //参数格式错误
    ParamsInvalid("4001", "Parameter Format Error"),

    //参数缺失错误
    ParamMissing("4002", "Parameter Missing"),
    ...
    //运行时异常
    RuntimeException("5001", "Runtime Exception"),
    ...
    TypeMismatchException("4003", "Type Mismatch Exception"),

    //找不到适合 bean 属性的编辑器或转换器时抛出异常
    ConversionNotSupportedException("5002", "Not Acceptable"),
